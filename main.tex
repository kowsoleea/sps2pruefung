...
Ergebnis steht in \autoref{tonarten1} auf \autopageref{tonarten1}.
...
Vorzeichen.\comment{Vorzeichen} In \autoref{entchen} auf \autopageref{entchen} 
...
(siehe \autoref{tonarten1} auf \autopageref{tonarten1}).
...
auf \autopageref{tonarten2} nach Anzahl der Vorzeichen sortiert.
